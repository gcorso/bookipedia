...
public class Constants {
    ...
    public static final String Genres[] = {"Adventure", "Romance", "Science Fiction", "Fantasy", "Mystery",
            "Gothic Novel", "Tragedy", "Historical Fiction", "Bildungsroman", "Drama", "Comedy",
            "Politics and Economics", "Modernism", "Novel of Manners" };

    public static final String GenresReg[] = {"Favorite genre...", "Adventure", "Romance", "Science Fiction",
            "Fantasy", "Mystery", "Gothic Novel", "Tragedy", "Historical Fiction", "Bildungsroman",
            "Drama", "Comedy", "Politics and Economics", "Modernism", "Novel of Manners" };

    public static final int GenresImage[] = {R.drawable.genre_adventure, R.drawable.genre_romance, R.drawable.genre_science_fiction,
            R.drawable.genre_fantasy, R.drawable.genre_mystery, R.drawable.genre_gothic, R.drawable.genre_tragedy,
            R.drawable.genre_historical, R.drawable.genre_bildungsroman, R.drawable.genre_drama,
            R.drawable.genre_comedy, R.drawable.genre_politics, R.drawable.genre_modernism, R.drawable.genre_manners};

    public static final String Colors[] = { "#bbf5fffa", "#bbfff0f5", "#bbfffacd", "#bbffe4e1", "#bbffdead", "#bbf0ffff", "#bbe6e6fa",
            "#bbffe4c4", "#bbe1f7d5", "#bbffbdbd", "#bbc9c9ff", "#bbf1cbff", "#bbffffba"};
